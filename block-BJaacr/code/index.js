...
log(got.houses.length);

// 3. Log the name of all houses in got one by one
log(got.houses[0].name);
log(got.houses[1].name);
...
for (let i = 0; i < got.houses.length; i++) {
  if (got.houses[i].name === "Starks") {
    for (let i = 0; i < got.houses[0].people.length; i++) {
      log(got.houses[0].people[i].name);
    }
  }
}
...
for (let i = 0; i < got.houses.length; i++) {
  if (got.houses[i].name === "Lannisters") {
    for (let i = 0; i < got.houses[1].people.length; i++) {
      log(got.houses[1].people[i].name);
    }
  }
}
...
for (let i = 0; i < got.houses.length; i++) {
  if (got.houses[i].name === "Lannisters") {
    for (let i = 0; i < got.houses[1].people.length; i++) {
      log(got.houses[1].people[i].description);
    }
  }
}
...
for (let i = 0; i < got.houses.length; i++) {
  if (got.houses[i].name === "Lannisters") {
    for (let i = 0; i < got.houses[1].people.length; i++) {
      log(
        `Im ${got.houses[1].people[i].name} and my bio is ${got.houses[1].people[i].description}`
      );
    }
  }
}
...
for (let i = 0; i < got.houses.length; i++) {
  if (got.houses[i].name === "Starks") {
    for (let i = 0; i < got.houses[0].people.length; i++) {
      log(
        `Im ${got.houses[0].people[i].name} and my bio is ${got.houses[0].people[i].description}`
      );
    }
  }
}
...
for (let i = 0; i <= (got.houses.length -1); i++) {
  got1[got.houses[i].name] = got.houses[i].people.length;
}
log(got1);
...
for(let i=0; i<got.houses.length; i++){
  for(let j=0; j<got.houses[i].people.length; j++){
    log(j +" "+ got.houses[i].people[j].name)
  }
}
...
for(let i=0; i<got.houses.length; i++){
  for(let j=0; j<got.houses[i].people.length; j++){
    allDescriptions.push(got.houses[i].people[j].description)
  }
}
log(allDescriptions)
// 19. Log the value and length `allDescription`
log(allDescriptions)
log(allDescriptions.length)
...
for(let i=0; i<got.houses.length; i++){
  for(let j=0; j<got.houses[i].people.length; j++){
    if(got.houses[i].people[j].description.length > 30){
      log(got.houses[i].people[j].description);
    }
  }
}